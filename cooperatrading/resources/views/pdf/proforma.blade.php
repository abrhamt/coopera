...
<head>
    ...
    <style>
        ...
        .logo { font-size: 22px; font-weight: 800; color: #1D2855; letter-spacing: -0.5px; }
        ...
        .footer { margin-top: 36px; padding-top: 16px; border-top: 1px solid #e2e8f0; color: #94a3b8; font-size: 9px; text-align: center; }
    ...
    <div class="header-flex">
        <div class="header-cell">
            <div style="display: flex; align-items: center; gap: 10px;">
                <div style="width: 40px; height: 40px; background: #0f172a; color: #fff; border-radius: 6px; display: flex; align-items: center; justify-content: center; font-weight: 800; font-size: 14px;">CT</div>
                <div>
                    <div class="logo">{{ $app_name ?? 'Cooper Trading' }}</div>
...
<div class="footer">
    {{ $app_name ?? 'Cooper Trading' }} · {{ $proforma->proforma_number }} · Generated {{ now()->format('M d, Y H:i') }}
</div>
